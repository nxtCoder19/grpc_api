 ...
 * @return {string}
 */
proto.todo.createTodoRequest.prototype.getName = function() {
 ...
 */
proto.todo.createTodoRequest.prototype.setName = function(value) {
...
proto.todo.TodoResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    todo: jspb.Message.getFieldWithDefault(msg, 3, "")
  };
